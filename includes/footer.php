            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Oct 15, 2024</a></div>
          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 St. Kambol, ChaomChav, Phnom Penh</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+855 70 923 129</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">kimlyjr11@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
